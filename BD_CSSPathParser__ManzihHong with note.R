...
#Step 3 : get the every complaint in 2nd layer web page
...
#for test
#if you want to use map(), you should import tidyvesre
url = "https://www.consumercomplaints.in/blue-dart-express-didnt-deliver-consignment-in-the-given-address-c2010573"
res = url %>% GET()
res
res %>% content(as = "text")
...
#for test
BD <-read_html("https://www.consumercomplaints.in/bluedart-poor-service-by-bluedart-c2010739")
cast <- html_nodes(BD, xpath = "/html/body/div[4]/div/div/div[1]/div/table[1]/tbody/tr[2]/td/div[1]")
html_text(cast)
html_name(cast)
html_attrs(cast)
